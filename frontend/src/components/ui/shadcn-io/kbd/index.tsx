...
export const Kbd = ({
  ...
  <span
    className={cn(
      'bg-muted text-muted-foreground inline-flex select-none items-center gap-1 rounded border px-1.5 align-middle font-mono text-[10px] font-medium leading-loose',
      className,
    )}
    {...props}
  >
...
export const KbdKey = ({ className: _className, ...props }: KbdKeyProps) => <kbd {...props} />;
